    ...
    public  class AssignableSideScreenRowPatch
    {
        ...
        public class AssignableSideScreenRow_GetTooltip_Patch
        {
            public static IEnumerable<CodeInstruction> Transpiler(ILGenerator _, IEnumerable<CodeInstruction> orig)
            {
                ...
                var m_GetNewString = AccessTools.Method(typeof(AssignableSideScreenRow_GetTooltip_Patch), "GetNewString", new[] { typeof(string), typeof(AssignableSideScreen) });
            ...
            {
                return sideScreen.targetAssignable != null && sideScreen.targetAssignable.GetComponent<HelmetController>() != null ? "Capped {0}" : originalEntry;
            }
        }
    }
}
