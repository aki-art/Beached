...
namespace Beached.Patches
{
    public class FetchManagerPatch
    {
        ...
        [HarmonyPatch(typeof(FetchManager), "FindEdibleFetchTarget")]
        public class FetchManager_FindEdibleFetchTarget_Patch
        {
            public static IEnumerable<CodeInstruction> Transpiler(ILGenerator _, IEnumerable<CodeInstruction> orig)
            {
                ...
                var f_PathCost = typeof(FetchManager.Pickup).GetField("PathCost");
                ...
                var m_InjectedMethod = AccessTools.Method(typeof(FetchManager_FindEdibleFetchTarget_Patch), "InjectedMethod", new[]
                {
                    typeof(ushort),
            ...
            private static ushort InjectedMethod(ushort originalValue, FetchManager.Pickup pickupable, Storage storage)
            {
