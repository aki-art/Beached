	...
	public class RareGemsConfig : IMultiEntityConfig
	{
		...
		public List<GameObject> CreatePrefabs() =>
			[
				...
				BEntityTemplates.CreateSimpleItem(MOTHER_PEARL, STRINGS.ITEMS.GEMS.MOTHER_PEARL.NAME, STRINGS.ITEMS.GEMS.MOTHER_PEARL.DESCRIPTION, "beached_motherpearl_kanim", DECOR.BONUS.TIER5, Elements.pearl)
			];
